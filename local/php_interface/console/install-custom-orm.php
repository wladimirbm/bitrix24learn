...
$connection->queryExecute("
	...
	(ID, FIRSTNAME, LASTNAME, MIDDLENAME, ABOUT, BIRTHDAY, DUTY_ID) 
	values 
	(1, 'Первый', 'Саша', '', 'абырвалг 1', '1990-12-12', 1),
	(2, 'Второй', 'Миша', '', 'абырвалг 2', '1991-1-12', 1),
	(3, 'Третья', 'Аня', '', 'абырвалг 3', '1992-2-12', 1),
	(4, 'Четвертый', 'Коля', '', 'абырвалг 4', '193-3-12', 1)
");
